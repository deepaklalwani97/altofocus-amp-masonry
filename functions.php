...
/**
 * Get grid-row-end property based on image height
 *
 * @return string
 */
function get_image_span() {
	$image_height = wp_get_attachment_image_src( get_post_thumbnail_id(), 'altofocus-thumb-image' )[2];
	return 'grid-row-end: span ' . calculate_image_span( $image_height ) . ';';
}
 ...
 * @return int
 */
function calculate_image_span( $height ) {
